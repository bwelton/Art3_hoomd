if (PYTHON_VERSION_STRING VERSION_GREATER 3.0 OR PYTHON_VERSION_STRING VERSION_LESS 2.7)
	...
	configure_file (
	    "${PROJECT_SOURCE_DIR}/src/wrappers/python_install.sh.in"
		"${PROJECT_BINARY_DIR}/wrappers/python_install.sh"
	)
	configure_file (
  		"${PROJECT_SOURCE_DIR}/src/wrappers/python_configure.sh.in"
	...
	set(PYTHON_INCLUDE_DIR "${CMAKE_INSTALL_PREFIX}/include/python2.7")
